...
echo "⚠️ The system will need to reboot after the installation is complete."
...
echo "⚠️ A system reboot is required to apply changes."
read -p "Press [Enter] to reboot now or [Ctrl+C] to abort and reboot later..."
sudo reboot
